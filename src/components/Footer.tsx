            ...
            <ul className="space-y-2">
              ...
              <li>
                <span
                  ...
                  className="text-sm text-[#8A8A90] inline-flex items-center gap-1.5 cursor-not-allowed"
                >
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  Discord
                  <span className="ml-1 px-1.5 py-0.5 rounded-full text-[9px] font-mono uppercase tracking-wider border border-white/10 text-[#6A6A70]">
                    Soon
                  </span>
                </span>
              </li>
